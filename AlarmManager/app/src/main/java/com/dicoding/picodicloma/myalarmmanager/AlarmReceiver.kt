package com.dicoding.picodicloma.myalarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_ONE_TIME = "OneTypeAlarm"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        showAlarmNotificiation(context, title, message, notifId)
    }
    ...
    fun setOneTimeAlarm(
        ...
        Toast.makeText(
            context,
            "One time alarm has been set up",
            Toast.LENGTH_SHORT
        ).show()
    }
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(
            context,
            "Repeating alarm has been set up",
            Toast.LENGTH_SHORT
        )
            .show()
    }
    ...
    private fun showAlarmNotificiation(
        context: Context,
        title: String,
        message: String,
        notifId: Int
